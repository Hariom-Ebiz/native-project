...
const Course = ({ categories, progress, thirdCompleted }) => {
  ...
  const {request: requestDownloadCertificate, response: responseDownloadCertificate} = useRequest();
  ...
  const pushToLessonsListingHandler = (
    ...
    // router.push(`/interview-skills/lesson/description/${lessonId}`);
    router.push(`/interview-skills/lesson/${courseId}`);
    ...
    //     // router.push(
    //     //   {
    //     //     pathname: `/interview-skills/lesson/description/${lessonId}`,
    //     //     query: {
    //     //       id: categoryId,
    //     //     },
    //     //   },
    //     //   `/interview-skills/lesson/description/${lessonId}`
    //     // );
    //   } else {
    //     router.push(`/interview-skills/lesson/${courseId}`);
    //   }
  ...
  const handleDownloadCertificate = () => {
    requestDownloadCertificate("get", "interview-skills/download-certificate");
  }
  ...
  return (
    <JobSeekerAuth data={{ title: "Interview Skills" }}>
                ...
                <div key={category.id}>
                  ...
                  <div className="row g-4">
                    {category.courses.map((course) => {
                      console.log("asdfadsf", course);
                      
                      const totalSeconds = course?.interview_lessons?.reduce((sum, l)=> {
      ...
      >
        ...
        <Modal.Body>
          <div style={{ textAlign: "left" }}>
            <p>
            {t("Learn how to prepare for job interviews and excel at every stage—before, during, and after the interview. Gain the confidence and techniques needed to ace your next interview and secure the job")}
            </p>
          </div>
        </Modal.Body>
      </Modal>
