          ...
          <ul className="sideNav_menu">
            ...
            <li className="dash_nav_item">
              ...
              <ul 
                ...
                <li>
                  <Link href="/employer/manage-jobs" className={`${pathname == "/employer/manage-jobs" ? "active" : ""
                  }`}>
                    <span>
                      <svg
                        width="24"
                ...
                <li>
                  <Link href="/employer/search-cv" className={`${pathname == "/employer/search-cv" ? "active" : ""
                  }`}>
                    <span>
                      <svg
                        width="24"
            ...
            <li className="dash_nav_item">
              <Link
                ...
                <span className="title_dash_nav">My Company</span>
              </Link>
            </li>
            <li className="dash_nav_item">
