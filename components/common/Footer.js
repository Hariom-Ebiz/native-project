...
const Footer = () => {
  ...
  return (
    <>
      <footer className="footer_wrapper" id="body_lang_css">
          ...
          <div className="row">
            ...
            <div className="col-md-6 col-lg-4">
              <ul className="footer-links footer-links-box ">
                <li>
                  <Link href="/course?query=true">{t("Career Roadway")}</Link>
                </li>
                <li>
                  <Link href="/job-seeker/job-list" >{t("Jobs")}</Link>
                </li>
                <li onClick={ShowPopUp}>
                  <Link href="#!">{t("Community Gate")}</Link>
                </li>
                <li>
                  <Link href="/#ourstory">{t("Our Story")}</Link>
                </li>
                <li>
                  {" "}
