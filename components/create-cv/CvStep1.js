      ...
      <div className={styles.form_wrapper}>
        <form>
          <div className="row g-4">
            ...
            <div>
              <label htmlFor="contact_mobile" className={styles.form_label}>Mobile Number</label>
              <PhoneInput
            ...
            <div>
              <label htmlFor="contact_alt_mobile" className={styles.form_label}>Alternative Number</label>
              <PhoneInput
                // inputClass={`${styles.form_control} form-control`}
                ...
                {...register("contact_alt_mobile", {
                  ...
                  validate: {
                    notSameAsAlt: value => value !== mobileNumber || "Mobile number and alternative number must not be the same."
                  }
                })}
