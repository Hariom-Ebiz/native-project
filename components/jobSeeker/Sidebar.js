...
const Sidebar = () => {
  ...
  const { loggedIn, userId, cvStep, firstName, lastName, was_subscriber } = useSelector(
    (store) => store.auth
  );
  ...
  useEffect(() => {
    if (
      ...
      pathname.includes("/job-seeker/job-description")
    ) {
      setMenuState({
        jobs: true,
        career: false,
      ...
      pathname == "/job-seeker/explore-our-packages" ||
      pathname == "/job-seeker/my-membership" ||
      pathname == "/job-seeker/expansion-renewal"
    ) {
      setMenuState({
        jobs: false,
        career: false,
        ...
        <ul className="sideNav_menu">
          ...
          <li className="dash_nav_item">
            ...
            >
              ...
              <span className="title_dash_nav">{t("Profile")}</span>
            </Link>
          </li>
            ...
            >
              <li>
                ...
                >
                  ...
                  {cvStep === 5 ? (
                    <span className="cv_link">{t("CV Builder")}</span>
                  ) : (
                    <span className="cv_link">{t("CV Builder")}</span>
                  )}
                </Link>
              ...
              <li>
                <Link
                  href="/job-seeker/job-list"
                  className={(pathname == `/job-seeker/job-list` || (Object.keys(query).includes("from") && query.from == "job-list")) ? 'active' : ""}
                >
                  <span>
                    <svg
                      width="24"
              ...
              <li>
                <Link href="/job-seeker/application-history" className={(pathname == `/job-seeker/application-history` || (Object.keys(query).includes("from") && query.from == "applications")) ? 'active' : ""}>
                  <span>
                    <svg
                      width="24"
                      height="24"
              ...
              <li>
                <Link
                  ...
                  className={pathname == `/job-seeker/invitations` ? 'active' : ""}
                >
                  <span>
                    <svg
                      width="24"
          ...
          <li className="dash_nav_item">
            ...
            >
              ...
              <span className="title_dash_nav">{t("Career Roadway Gate")}</span>
              <span className="arrowIconSubmenu"></span>
            </a>
            <ul
            ...
            >
              ...
              <li>
                <Link
                  href="/functional-mastery?query=true"
                  onClick={() => dispatch(openAuthSidebar(false))}
                  className={
                    pathname == `/functional-mastery` ||
                      pathname == "/functional-mastery/chapter/[id]" ||
