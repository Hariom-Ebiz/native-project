...
const Course = ({ categories, courses }) => {
  ...
  const pushToLessonsListingHandler = (
    ...
    router.push(`/standout/lessons/${courseId}`);
            ...
            <div className="row g-4">
              {courses.map((course) => (
                <>
                        ...
                        <div className={style.course_detais}>
                          <div className={style.progress_bar}>
                            <div className={style.progress_bar_heading}>
                              <span>Progress</span>
                              <span>{((course.totalCompletedLessons / (course.totalLessons > 0 ? course.totalLessons : 1))) * 100}%</span>
                            </div>

                            <div className="progress_bar_block">
                              <ProgressBar
                                now={((course.totalCompletedLessons / (course.totalLessons > 0 ? course.totalLessons : 1))) * 100}
                              />
                            </div>
                          </div>
                          ...
                          <div className={style.lesson_time}>
                            <span>
                              ...
                              {course.totalCourseTime ?? 0} min
                            </span>
                            <Link
                              href={`/standout/lessons/${course.id}`}>
                              <svg
                                width="13"
                                height="17"
                                viewBox="0 0 13 17"
                  ...
                  <div
                    // id={categories[categoryKey] + "-" + course.id}
                    style={{
                      position: "relative",
                      bottom: "100px",
                      width: "0px",
