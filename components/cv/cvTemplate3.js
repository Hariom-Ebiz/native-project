      ...
      <Page size="A4" style={{ ...styles.body }}>
        <View style={styles.container}>
            ...
            <View style={{ "display": "-webkit-inline-box", "display": "flex", "flexDirection": "row", "width": "100%", "paddingBottom": "5px" }}>
              <View style={{ "width": "50%" }}>
                <Text style={{ fontSize: "11px", margin: "0" }}>
                  ...
                  <Text style={{"paddingLeft": "10px", fontSize: "11px"}}>{generalData?.current_area_name || generalData?.current_other_area}, {generalData?.current_city_name}, {generalData?.current_country_name}</Text>
                </Text>
              </View>
              <View style={{ "width": "50%" }}>
                <Text style={{ "fontSize": "11px", "margin": "0"}}>
            ...
            <View style={{ "display": "-webkit-inline-box", "display": "flex", "flexDirection": "row", "width": "100%", "paddingBottom": "5px" }}>
              <View style={{ "width": "50%" }}>
                <Text style={{ "fontSize": "11px", "margin": "0"}}>
                  ...
                  <Text style={{"paddingLeft": "10px"}}>{phoneNumber.formatInternational() || "--"}</Text>
                </Text>
              </View>
              {
                generalData?.linked_in ? 
                  <View style={{ "width": "50%" }}>
                    <Text style={{ "fontSize": "11px", "margin": "0"}}>
                      ...
                      <Text style={{ "color": "#0462c1", "paddingLeft": "10px" }}>
              ...
              <View style={styles.section}>
...

                {
                  workExperienceData.map((w, i) => {
                    ...
                    return (
                      <View style={{ "display": "-webkit-inline-box", "width": "100%", "display": "flex", "flexDirection": "row" , "marginTop": (i > 0) ? "10px" : "2px", "marginBottom": "5px"}}>
                        <View style={{ "width": "14%" }}>
                        ...
                        <View style={{ "width": "86%)" }}>
                          <View style={{ "display": "block" }}>
                            ...
                            <Text style={{ "margin": "0", "color": "#44536a", "fontSize": "12px", "fontWeight": "500", "paddingTop": "5px" }}>
                          ...
                          <View style={{ "display": "block" }}>
                            <Text style={{ "color": "#000", "fontSize": "14px", "fontWeight": "600", "margin": "0", "display": "block" }}>
                              {val.field_of_study_name || val.other_field_of_study || val.field_of_study}
                                                    , {(val?.topic) ? `${(val?.topic)}, ` : ""}{val?.organisation_name}
                            </Text>
                          </View>
                        </View>
                      </View>
          ...
          <View style={styles.section}>
            <View style={{ "display": "-webkit-inline-box", "display": "flex", "flexDirection": "row", "marginBottom": "10px" }}>
              <View>
                <Image src="/img/cv3-personal-info.jpg" style={styles.imgStyle} />
              </View>
              <View style={{ "display": "block" }}>
                <Text style={{ "fontSize": "16px", "fontWeight": "bold", "color": "#002d57", "margin": "5px 0 0 10px" }}>
            ...
            <View style={{ "display": "-webkit-inline-box", "width": "100%", "display": "flex", "flexDirection": "row" }}>
              ...
              <View style={{ "width": "90%" }}>
                <View style={{ "display": "-webkit-inline-box", "display": "flex", "flexDirection": "row", "flexWrap": "wrap", "width": "100%" }}>
                    <View style={{"width": "50%", "flexDirection": "row"}}>
                        <Text style={{"fontSize":"12px", "margin":"0", "color": "#262424", "fontWeight": "600", "textTransform": "capitalize"}}>Date of Birth: &nbsp;&nbsp; - &nbsp;&nbsp;</Text>
                        
                        <Text style={{"fontSize":"12px", "margin":"0", "color": "#262424", "textTransform": "capitalize"}}>{moment(generalData?.dob).format("MMMM DD, YYYY")}</Text>
                    </View>

                    <View style={{"width": "50%", "flexDirection": "row"}}>
                        <Text style={{"fontSize":"12px", "margin":"0", "color": "#262424", "fontWeight": "600", "textTransform": "capitalize"}}>Marital Status: &nbsp;&nbsp; - &nbsp;&nbsp;</Text>
                        
                        <Text style={{"fontSize":"12px", "margin":"0", "color": "#262424", "textTransform": "capitalize"}}>{generalData?.martial_status || "--"}</Text>
                    </View>


                    <View style={{"width": "50%", "flexDirection": "row"}}>
                        <Text style={{"fontSize":"12px", "margin":"0", "color": "#262424", "fontWeight": "600", "textTransform": "capitalize"}}>Nationality: &nbsp;&nbsp; - &nbsp;&nbsp;</Text>
                        
                        <Text style={{"fontSize":"12px", "margin":"0", "color": "#262424", "textTransform": "capitalize"}}>{generalData?.nationality_name}</Text>
                    </View>
                </View>
              </View>
            </View>
