...
const styles = StyleSheet.create({
    ...
    employementPointsText: { "margin": "0", "color": "#423e3e", "fontSize": "12px", "display": "flex" },
    bullets: {"fontSize": "9px"},
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={{ ...styles.p, ...styles.profileBioView }}>
                            <Text style={styles.profileBio}>{generalData?.current_area_name || generalData?.current_other_area}, {generalData?.current_city_name}, {generalData?.current_country_name}</Text>
                            <Text style={{ ...styles.profileBio, "display": "block" }}>Email: <Text style={{ "color": "#0462c1" }}>{generalData?.contact_email ?? "-"}</Text></Text>
                            <Text style={{ ...styles.profileBio, "display": "block" }}>Mobile: {phoneNumber.formatInternational() || "--"}</Text>
                            {
                    ...
                    <View style={{...styles.section, "borderBottom": "none"}}>
                        ...
                        <View style={{...styles.employementView, "paddingBottom": "3px", "marginBottom": "3px"}}>
                            <Text style={{...styles.employementViewLeftSecion, "color": "#262424", "fontSize": "12px", fontWeight: "bold"}}>
                                Date of Birth 
                            </Text>
                            <View style={styles.employementViewMiddleSecion}>
                                <Text style={{"color": "#262424", "margin": "0", "textTransform": "capitalize", "fontSize": "12px"}}>
