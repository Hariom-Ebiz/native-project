...
const Package = ({ courses }) => {
    const {subscription: {standout},is_subscriber}  = useSelector(store => store.auth)
    ...
    const pushToLessonsListingHandler = (
        ...
        const pushHandler = () => {
            ...
            if (skip_lessons) {
                router.push(`/standout/lesson/description/${lessonId}`);
            } else {
                router.push(`/standout/lesson/${courseId}`);
            }
        };
    };
    ...
    const handlePackageStartClick = (course) => {
        if(standout){
            router.push(`/standout/chapter/${course.id}`)
        } else {
    ...
    return (
        <JobSeekerAuth data={{ title: "Standout Journey" }}>
                                                    ...
                                                    <div className={style.course_detais}>
                                                        <h3 className={style.course_tittle}>
                                                            <button
                                                                ...
                                                                onClick={() => { course?.totalLessons != 0 && router.push(`/standout/chapter/${course.id}`) }}
                                                            >
                                                                {course.title}
                                                            </button>
                                                        </h3>
                                                        <div className={style.progress_bar}>
                                                            ...
                                                            {console.log(">>>>",course.completed_percentage)}
                                                        ...
                                                        <div className={style.lesson_time}>
                                                            ...
                                                            <button
                                                                ...
                                                                // onClick={() => { router.push(`/standout/chapter/${course.id}`) }}
                                                                onClick={() => handlePackageStartClick(course)}
                                                            >
                                                                <svg
                                                                    width="13"
                                                                    height="17"
            ...
            >
                ...
                <Modal.Body>
                    <div className={style.modal_content} style={{ textAlign: "left" }}>
                        <p>
                            Achieve career readiness with our 'Standout' program designed to equip you with foundational skills crucial for success in any field. Discover the core competencies needed to excel in today's competitive job market.
                            <br />
                            <br />
                            Dive into eight crucial topics that form the foundation for any career path:
                            <ol>
                                <li style={{listStyle: "auto"}}>Full access to Learning Videos, Materials & Tools on:</li>
                                <li style={{listStyle: "auto"}}>Dare to Lead</li>
                                <li style={{listStyle: "auto"}}>Present Like a Pro</li>
                                <li style={{listStyle: "auto"}}>Negotiate to Win</li>
                                <li style={{listStyle: "auto"}}>Problem-Solving Essentials</li>
                                <li style={{listStyle: "auto"}}>Emotional Intelligence Mastery</li>
                                <li style={{listStyle: "auto"}}>Business Etiquette Essentials</li>
                                <li style={{listStyle: "auto"}}>Beyond Boundaries</li>
                            </ol>
                            Whether you're entering the workforce or looking to advance, you'll acquire the skills and knowledge necessary to stand out in your career.
            ...
            >
                <Modal.Header closeButton>
                    <div className={style.modal_content}>
                        <span style={{ fontSize: "24px", }}>Please Purchase standout Package !</span>
                    </div>
                </Modal.Header>
                <Modal.Body>
                    <div className={style.modal_content} style={{ textAlign: "left" }}>
                        <h6>
                            You have to purchase standout Package before accessing it.
                        </h6>
                        <div style={{width: "100%", maxWidth: "350px", margin: "auto", fontWeight: 400, fontSize: "18px", fontFamily: "Montserrat", textAlign: "center", color: "#fff"}}>
                            <Link href={is_subscriber ? "/job-seeker/expansion-renewal" : "/job-seeker/explore-our-packages"} style={{background: "#161d46", display: "flex", padding: "12px 24px", justifyContent: "center", alignItems: "center", gap: "10px", borderRadius: "15px", marginTop: "25px",color: "#fff"}}>Purchase Now</Link>
                        </div>
                    </div>
                </Modal.Body>
            </Modal>
