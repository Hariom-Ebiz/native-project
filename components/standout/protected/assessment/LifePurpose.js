...
const LifePurpose = ({ progressId, lessonId, nextLink, courseBackId }) => {
  ...
  return (
    <>
      <div className={styles.instructions_wrapper}>
        {/* <h3>Instructions</h3> */}
        <p>
          In the upcoming Life Purpose statement, you will be guided to complete
          two distinct parts: the first one relates to Essence, while the second
        ...
        <Modal.Body>
          <div className="modal_inner">
            ...
            <div className={styles.modal_result}>
              ...
              <Link
                href={`/job-seeker/my-profile/#lifePurpose?id=${courseBackId}`}
              >
                Profile
              </Link>
            </div>
