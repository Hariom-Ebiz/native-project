  ...
  return (
    <div className="col-md-10 col-lg-3">
      <div className={styles.step_wrapper}>
        <ul className={styles.create_cv_page_ul}>
          <li>
            <Link
              className={
                pathname == "/job-seeker/create-cv/step1" ? styles.active : {}
              }
              href="/job-seeker/create-cv/step1"
            >
              ...
              <span className={styles.right_arrow}>
                <svg width="7" height="14" viewBox="0 0 7 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1.28223 12.4105L5.9203 7.77246C6.46804 7.22471 6.46804 6.3284 5.9203 5.78065L1.28223 1.14258" 
                     stroke-width="1.28045" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </span>
          ...
          <li>
            <Link
              href="/job-seeker/create-cv/step2"
              className={
                pathname == "/job-seeker/create-cv/step2" ? styles.active : {}
              }
            >
              <span className={styles.page_link}>
                <svg
          ...
          <li>
            <Link
              href="/job-seeker/create-cv/step3"
              className={
                pathname == "/job-seeker/create-cv/step3" ? styles.active : {}
              }
            >
             <span className={styles.page_link}> 
              <svg
          ...
          <li>
            <Link
              href="/job-seeker/create-cv/step4"
              className={
                pathname == "/job-seeker/create-cv/step4" ? styles.active : {}
              }
            >
              <span className={styles.page_link}>
              <svg
          ...
          <li>
            <Link
              href="/job-seeker/create-cv/step5"
              className={
                pathname == "/job-seeker/create-cv/step5" ? styles.active : {}
              }
            >
              <span className={styles.page_link}>
              <svg
...
export default SidebarCreateCv;
