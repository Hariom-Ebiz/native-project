...
const Header = ({ data }) => {
  ...
  useEffect(() => {
    let pathChange = router.pathname.split("/");
    if (pathChange[2] == "create-cv") {
      setButtonShow(true);
    }
  }, []);
    ...
    <>
              ...
              <h1 className="dash_page_heading">
                ...
                {buttonShow && (
                  <div className="right_btn_head">
                    <div className="showingFull">{data?.title}</div>
                    <Link href="/job-seeker/dashboard">
                      <button className="btn btn-primary header_btnNew  skip_Now backDashBoardBtn">
                      <svg
                      width="24px"
                      height="12"
                      viewBox="0 0 14 8"
                    ...
                    >
                      <path
                        d="M0.5 4H10.5M10.5 4L7 7.5M10.5 4L7 0.5M13.5 0.5V7.5"
                        stroke="currentcolor"
      ...
      {buttonShow && (
        <Link
          ...
          className="btn-primary backFixedBtn journey-content"
        >
          Back to Dashboard
          <svg
            width="24px"
