...
const careerJournyModal = require("../models/careerJourney");
...
exports.getAllStandoutCourse = async (req, res, next) => {
    ...
    try {
        list = await careerJournyModal.getAllCourses({
            query: {...extras},
            page,
            per_page,
            sort_by,
...
exports.deleteStandoutCourse = async (req,res,next) =>{
    ...
    try {
        await careerJournyModal.deleteCourse({ id });
        await careerJournyModal.deleteLesson({ "course_id": id });
    } catch (err) {
        console.log("err : ",err);
        const error = new HttpError(
            req,
...
//     let data;
//     try {
//         data = await standOutCourses.getOneCourse({ "courses.id": id });
//         if (!data) {
//             const error = new HttpError(
//                 req,
//                 new Error().stack.split("at ")[1].trim(),
...
exports.getAllStandoutLessonsByCourses = async (req, res, next) => {
    ...
    try {
        list = await careerJournyModal.getAllLessons({
            match: {},
            page,
            per_page,
            sort_by,
...
exports.deleteStandoutLesson = async (req,res,next) =>{
    ...
    try {
        await careerJournyModal.deleteLesson({ id });
    } catch (err) {
        console.log("err : ",err);
        const error = new HttpError(
            req,
...
//     let data;
//     try {
//         data = await standOutCourses.getOneLesson({ "lessons.id": id });
//         if (!data) {
//             const error = new HttpError(
//                 req,
//                 new Error().stack.split("at ")[1].trim(),
...
exports.createCategory = async (req, res, next) => {
    ...
    try {
        await careerJournyModal.createCategory(updates);
    } catch (err) {
        const error = new HttpError(
            req,
            new Error().stack.split("at ")[1].trim(),
...
exports.updateCategory = async (req, res, next) => {
    ...
    try {
        await careerJournyModal.updateCategory({ id }, updates);
    } catch (err) {
        const error = new HttpError(
            req,
            new Error().stack.split("at ")[1].trim(),
...
exports.getCategoryCourses = async (req, res, next) => {
    ...
    try {
        [categories, progress, thirdCompleted] = await Promise.all([
            careerJournyModal.getCategoryCourses(req.userId ?? 0),
            User.getCourseProgress("course_categories", req.userId),
            careerJournyModal.lessonCheckThirdCategoryIsCompleted(req.userId ?? 0),
        ]);
    } catch (err) {
        const error = new HttpError(
            req,
    ...
    categories = categories.map((category) => {
        category.courses = category.courses.map((course) => {
            ...
            course.lessons = course?.lessons?.reduce((finalLessons, lesson) => {
                if (lesson && lesson.id) {
...
exports.thirdCategory = async (req, res, next) => {
    ...
    try {
        isThirdCategoryCompleted = await careerJournyModal.lessonCheckThirdCategoryIsCompleted(
            req.userId
        );
    } catch (err) {
        const error = new HttpError(
...
exports.getAllStandoutCategory = async (req, res, next) => {
    ...
    try {
        list = await careerJournyModal.getManyCategories({
            match: {},
            page,
            per_page,
            sort_by,
...
exports.getOneStandoutCategory = async (req, res, next) => {
    ...
    let data;
    try {
        data = await careerJournyModal.getOneCategory({ id });
        if (!data) {
            const error = new HttpError(
                req,
                new Error().stack.split("at ")[1].trim(),
...
exports.deleteStandoutCategory = async (req, res, next) => {
    ...
    try {
        await careerJournyModal.deleteCategory({ id });
    } catch (err) {
        console.log("err : ",err);
        const error = new HttpError(
            req,
...
exports.getAllStandoutPackage = async (req, res, next) => {
    ...
    try {
        list = await careerJournyModal.getAllCoursePackages({
            match: {},
            page,
            per_page,
            sort_by,
...
exports.getOneStandoutPackage = async (req, res, next) => {
    ...
    let data;
    try {
        data = await careerJournyModal.getOneStandoutPackage({ id });
        if (!data) {
            const error = new HttpError(
                req,
                new Error().stack.split("at ")[1].trim(),
...
exports.deleteStandoutPackage = async (req, res, next) => {
    ...
    try {
        await careerJournyModal.deleteStandoutPackage({ id });
    } catch (err) {
        console.log("err : ",err);
        const error = new HttpError(
            req,
...
exports.createStandoutPackage = async (req, res, next) => {
    ...
    try {
        await careerJournyModal.createStandoutPackage({
            title,
            description,
            image: course_image,
            created_at: dateTimeFormat(),
...
exports.updateStandoutPackage = async (req, res, next) => {
    ...
    try {
        await careerJournyModal.updateStandoutPackage({ id }, extras);
    } catch (err) {
        const error = new HttpError(
            req,
            new Error().stack.split("at ")[1].trim(),
...
exports.createCourse = async (req, res, next) => {
    ...
    try {
        await careerJournyModal.createCourse({
            category_id,
            title,
            description,
            time,
...
exports.updateCourse = async (req, res, next) => {
    ...
    try {
        await careerJournyModal.updateCourse({ id }, extras);
    } catch (err) {
        const error = new HttpError(
            req,
            new Error().stack.split("at ")[1].trim(),
...
exports.getOneCourse = async (req, res, next) => {
    ...
    try {
        course = await careerJournyModal.getOneCourse({ "courses.id": id });
    } catch (err) {
        console.log(err);
        const error = new HttpError(
            req,
...
exports.getAllCourses = async (req, res, next) => {
    ...
    try {
        courses = await careerJournyModal.getAllCourses({
            page: 1,
            per_page: 100,
...
exports.createLesson = async (req, res, next) => {
    ...
    if (files.video && files.video.length > 0) {
        ...
        const res = await getVideoLength(files.video[0].filename);
        if(res.status){
            updates.total_seconds = res.duration
        }
    }
    ...
    try {
        await careerJournyModal.createLesson(updates);
    } catch (err) {
        const error = new HttpError(
            req,
            new Error().stack.split("at ")[1].trim(),
...
exports.updateLesson = async (req, res, next) => {
    ...
    try {
        await careerJournyModal.updateLesson({ id }, extras);
    } catch (err) {
        const error = new HttpError(
            req,
            new Error().stack.split("at ")[1].trim(),
...
exports.getOneLesson = async (req, res, next) => {
    ...
    try {
        lesson = await careerJournyModal.getOneLesson(
            { "lessons.id": id },
    ...
    try {
        nextLesson = careerJournyModal.lessonGetOneTwo({
            "lessons.course_id": lesson.course_id,
            "lessons.order_number": lesson.order_number + 1,
        });

        course = careerJournyModal.getOneCourse({ "courses.id": lesson.course_id });
        ...
        nextCourse = await careerJournyModal.getOneCourse({
            category_id: course.category_id,
            "courses.order_number": course.order_number + 1,
        });

        if (!nextCourse) {
            nextCourse = await careerJournyModal.getOneCourse({
                category_id: course.category_id + 1,
                "courses.order_number": 1,
            });
        }
        ...
        if (nextCourse) {
            nextCourseLesson = await careerJournyModal.lessonGetOneTwo({
    ...
    try {
        ...
        previousLesson = await careerJournyModal.lessonGetOneTwo({
            "lessons.course_id": lesson.course_id,
            "lessons.order_number": lesson.order_number - 1,
        });

        if (!previousLesson) {
            previousLesson = await careerJournyModal.lessonRaw(
    ...
    if (
        ...
        const isExits = await careerJournyModal.getOneLessonProgress({
            user_id: req.userId,
            lesson_id: lesson.id,
            course_id: lesson.course_id,
        });
        ...
        if (!isExits) {
            if (lesson.is_assessment == 1) {
                const response = await careerJournyModal.createLessonProgress({
                    user_id: req.userId,
                    lesson_id: lesson.id,
                    course_id: lesson.course_id,
                    total_seconds: 1,
                ...
                await careerJournyModal.createLessonProgress({
                    user_id: req.userId,
                    lesson_id: lesson.id,
                    course_id: lesson.course_id,
                    total_seconds: 1,
    ...
    if (
        ...
        if (lesson.next_lesson_id && !lesson.is_another_course) {
            ...
            const nextLessonData = await careerJournyModal.lessonGetOneTwo({
        ...
        await Promise.all([
            ...
            // careerJournyModal.createLessonProgress({
            //   user_id: req.userId,
            //   lesson_id: lesson.id,
            //   course_id: lesson.course_id,
            //   total_seconds: 1,
    ...
    try {
        if (course.category_id == 3) {
            const isThirdCategoryCompleted =
                await careerJournyModal.lessonCheckThirdCategoryIsCompleted(req.userId ?? 0);
...
exports.getAllLesson = async (req, res, next) => {
    ...
    try {
        lessons = await careerJournyModal.lessonGetMany({
            page: 1,
            per_page: 100,
            sort_by: "order_number",
            order: "asc",
...
exports.getAllLessons = async (req, res, next) => {
    ...
    try {
        lessons = careerJournyModal.lessonGetManyClient({
            page: 1,
            per_page: 100,
            sort_by: "order_number",
            order: "asc",
        ...
        course = careerJournyModal.getOneCourse({ "courses.id": courseId });
...
exports.lessonUpdateId = async (req, res, next) => {
    ...
    for (let i = lastId; i >= firstId; i--) {
        await careerJournyModal.updateLessonProgress(
            {
                lesson_id: i,
            },
            {
...
exports.createLessonProgress = async (req, res, next) => {
    ...
    try {
        if (id) {
            ...
            response = await careerJournyModal.createLessonProgress(updates);
        }
    } catch (err) {
        const error = new HttpError(
            req,
...
exports.completeLessonProgress = async (req, res, next) => {
    const user_id = req.userId;
    const { id, total_seconds, lesson_id,course_id } = req.body;
    ...
    try {
        ...
        response = await careerJournyModal.updateLessonProgress(
        ...
        const isCouseCompletedRes = await careerJournyModal.checkIsCourseIsCompleted({query: {user_id}})
        console.log("isCouseCompletedRes",isCouseCompletedRes)
        if(isCouseCompletedRes.status && isCouseCompletedRes.data){
            await createCertificate(user_id, "Coaching Journey", "coaching_journey")
        }
        ...
        try {
            ...
            if (lesson.id >= progress.current_lesson_id) {
                ...
                if (lesson.next_lesson_id && !lesson.is_another_course) {
                    ...
                    const nextLessonData = await careerJournyModal.lessonGetOneThree({
                        "lessons.id": current_lesson_id,
                    });
