          ...
          <div>
            ...
            {categories.map((category) => (
              <>
                     ...
                     <div id={category.id} style={{ position: "relative", bottom: "100px" }}></div>
                ...
                <div key={category.id}>
                  ...
                  <div className="row g-4">
                    {category.courses.map((course) => {
                      ...
                      <div id={category.id + '-' + course.id} style={{position: 'relative', bottom: "100px",width:"0px",paddingLeft:"0px",paddingRight:"0px"}}>
