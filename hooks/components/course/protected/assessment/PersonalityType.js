...
const PersonalityType = ({ types, progressId, lessonId, nextLink }) => {
    ...
    <>
      ...
      <div className={styles.personality_wrapper}>
        ...
        <div className={` ${styles.inner_block_question}`}>
          ...
          <div className={`${styles.evenOddRow} ${styles.mobile_auto}`} id="scroll-div">
        ...
        <Modal.Body>
          <div className="modal_inner">
            ...
            <div className={styles.modal_result}>
              ...
              <Link href="/job-seeker/my-profile/#personalityType">
                Profile
              </Link>
            </div>
            <button
