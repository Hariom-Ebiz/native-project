...
const CareerInterests = ({
  ...
  return (
    <>
      ...
      <div className={`${styles.instructions_wrapper} ${styles.careerintrests_wrapper}`}>
     <h3>
          Welcome to our Career Interests Assessment. Please follow these steps
          to complete this assessment effectively :
          </h3>
        <p>
          <span>Step 1 :</span> Read each question carefully and decide how you feel about
          each type of activity. Choose either 'Like' or 'Dislike' to indicate
          your preference.
        </p>
        <p>
         <span> Step 2 :</span> Click the 'Next' button at the bottom of each screen to move
          on to the next section.
        </p>
        <p>
          <span>Step 3 :</span> After completing the assessment, you will discover your
          Interest Profile and its relevance to potential career paths.
        </p>
        <p>Let's begin!</p>
      </div>
        ...
        <Modal.Body>
          <div className="modal_inner">
            ...
            <div className={styles.modal_result}>
              ...
              <Link href="/job-seeker/my-profile/#careerInterests">
                Profile
              </Link>
            </div>
            <button
