  ...
  return (
    <>
      ...
      >
        ...
        {currentStep == 1 ? (
            <p>
              <span>Step 1: </span> Read carefully each skill with the
              explanation and classify them according to how much you enjoy
              using them. Level of enjoyment is classified into three
              categories:
          ...
          <Modal.Body>
            <div class="modal_inner">
              ...
              <div className={`${styles.modal_result} ${styles.top_space}`}>
                ...
                <Link href="/job-seeker/my-profile/#motivatedSkills">
                  Profile
                </Link>
              </div>
              <button
