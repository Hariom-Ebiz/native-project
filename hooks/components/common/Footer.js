...
const Footer = () => {
  ...
  const ShowPopUp = () => {
    dispatch(
      setModal(
        <>
          <div className="modal_inner" id="land_ar">
  ...
  return (
    <>
      {/* <footer className={["footer_wrapper", `${(lang == "AR") ? modalStyles.land_ar : ""}`]} id="body_lang_css"> */}
      <footer className={`footer_wrapper ${(lang == "AR") ? modalStyles.land_ar : ""}`} id="body_lang_css">
          ...
          <div className="row">
            ...
            <div className="col-md-6 col-lg-4">
              <ul className="footer-links footer-links-box ">
                ...
                <li>
                  <Link href="/employer/#ourstory">Our Story</Link>
                </li>
                <li>
                  {" "}
                  <Link href="/employer/contact-us">Contact Us</Link>
                </li>
              </ul>
            </div>
