const table = "job_seeker_universities";
  ...
  return new Promise((resolve, reject) => {
    DB(table)
      ...
      .leftJoin(
        ...
        "countries.id",
        "=",
        "job_seeker_universities.country"
      )
      .leftJoin("grades", "grades.id", "=", "job_seeker_universities.grade")
      .leftJoin(
        "degree_levels",
        "degree_levels.id",
        "=",
        "job_seeker_universities.degree_level"
      )
      .leftJoin(
        "study_fields",
        "study_fields.id",
        "=",
        "job_seeker_universities.field_of_study"
      )
      .where(query)
      .whereNot(notQuery)
      .then(function (record) {
