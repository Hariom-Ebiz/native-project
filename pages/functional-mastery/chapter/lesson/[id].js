...
import { API } from "@/api";
import { getLessons } from "@/services/functional-mastery";

import LessonPrivate from "@/components/functional-mastery/protected/Lesson";
import LessonPublic from "@/components/functional-mastery/public/Lesson";
...
export async function getServerSideProps(context) {
  ...
  if (lessons.length == 0) {
    return {
      redirect: {
        permanent: false,
        destination: "/funcational-mastery",
      },
    };
  }
