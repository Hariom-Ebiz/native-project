...
import { timeGapYearMonth } from "@/utils/helper";
                  ...
                  <div className="col-md-8">
                    <div className={styles.cv_dashboard}>
                      ...
                      >
                        ...
                        {workExperienceData?.length &&
                          workExperienceData.length > 1 && (
                            ...
                            >
                              Show {workExperienceData?.length - 1} more
                              experiences
                            </a>
                          )}
                      </div>
                      ...
                      >
                        ...
                        {postGraduationData &&
                          universityData &&
                          postGraduationData?.length + universityData?.length >
                            1 && (
                            <a
                      ...
                      >
                            ...
                            <>
                              ...
                              <img src="../../img/education.png" alt="" />
                                  ...
                                  <div className={styles.profile_inner_content}>
                                    ...
                                    >
                                      <li>
                                        Certification, {val.field_of_study_name}{" "}
                                        ({val.topic_name})
                                      </li>
                                    </ul>
                        ...
                        {certificationData && certificationData.length > 1 && (
                          ...
                          >
                            Show {certificationData?.length - 1} more
                            certifications
                          </a>
                        )}
                      </div>
