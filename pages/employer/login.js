...
const Login = ({ email, password }) => {
  ...
  const onSubmit = (data) => {
    ...
    request("POST", "user/employer/login", {
      email,
      password,
    });
  };
        ...
        <>
          <div className="modal_inner">
            <div className={modalStyles.icon_block}>
              <img src="/img/successful-io (1).png" alt="" />
            </div>
            <h3 className="modal_heading_formate">
              You have been <br></br> successfully registered
            </h3>
      ...
      if (response.status) {
        if (!response.isEmailVerified) {
          ...
          if (isRememberMe) {
            ...
            setCookie(null, "empEmail", email, {
              maxAge: 30 * 24 * 60 * 60 * 100,
              path: "/",
            });

            setCookie(null, "empPassword", password, {
              maxAge: 30 * 24 * 60 * 60 * 100,
              path: "/",
            });
          } else {
            destroyCookie(null, "empEmail");
            destroyCookie(null, "empPassword");
          }
  ...
  return (
    <Authentication>
      ...
      <section className={styles.Login_wrapper} id="body_lang_css">
              ...
              <div className="col-lg-6 col-md-6 col-sm-12">
                <div className={styles.login_sign_up_block}>
                  ...
                  <div className={styles.sign_type}>
                    ...
                    />
                    <Link href={""} onClick={() => {window.location.href = CANDIDATE_URL+"/login"}}>
                      <label
...
export async function getServerSideProps(context) {
  ...
  let email = cookies.empEmail ?? null;
  let password = null;

  if (email) {
    password = cookies.empPassword ?? null;
  }
