...
import styles from "../../styles/subscription_status.module.css";
    ...
    <>
      <div className="app">
        ...
        <div className="layout">
          ...
          <div className={`main_content ${styles.main_bg}`} id="body_lang_css">
              <div className="subscription-block-element">
                  <div className={styles.subscription_data_box}>
                      <div className={styles.subs_data}>
                          <h3 className={styles.sub_title}>Membership Details</h3>
                          <span className={styles.sub_planTitle}>Premium</span>
                          <span className={styles.sub_text}>Renewal Date: <span>12/12/2022</span></span>
                        </div>
                        <div className={styles.subs_dataRightBox}>
                          <a href="#!" className={styles.btn_secondary}>Canceled</a>
                          <a href="#!" className={`btn_secondary ${styles.violet_bgColor}`} >Cancel Membership</a>
                        </div>
                  </div>
                  <div className={`subscription_data_box ${styles.widthColor}`} >
                      <h3 className={styles.sub_title}>Premium plan details</h3>
                      <ul className={styles.sub_plan_details}>
                          <li>Remaining Aptitude Assessments to unlock:<span>15/60</span></li>
                          <li>Remaining CV to unlock:<span>15/30</span></li>
                      </ul>
                  </div>
          </div>
      </div>
