              ...
              <ul className="sideNav_menu">
                ...
                <li className="dash_nav_item">
                  <a href="#">
                    ...
                    <spa className={styles.title_dash_nav}>Help Center</spa>
                  </a>
                </li>
            ...
            <div className="main_content" id="body_lang_css">
              ...
              <div className="row">
                  <div className="col-md-4 col-sm-4">
                        ...
                        <p className={styles.company_profile_description}>Introduce your company core info quickly to users by fill up company details
                        </p>
                      </div>
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="form-group">
                                    ...
                                    <input type="text" className={styles.form_control} placeholder="Discord" />
                                </div>
                            </div>
                            <div className="col-12">
                              <div className="form-group">
                                  <label className={styles.form_label}>Website</label> 
                                  <input type="text" className={styles.form_control} placeholder="Https://www.discord.com" />
                              </div>
                            </div>
                            <div className="col-12">
                              <div className="form-group">
                                  <label className={styles.form_label}>Country</label> 
                                  <select className={`${styles.form_control} ${styles.steps_form_select}`}>
                          ...
                          <div className="col-12">
                              ...
                              <div className="row">
                                ...
                                <div className="form-group">      
                                      <label className={styles.form_label}>Employee</label> 
                                      <select className={`${styles.form_control} ${styles.steps_form_select} ${styles.Arrow} `}>
                                        <option>1-50</option>
                                      </select>
                                </div>
                                </div>
                                ...
                                <div className="col-sm-6">
                                  <div className="form-group">
                                      ...
                                      <label className={styles.form_label}>Industry</label> 
                                      <select className={`${styles.form_control} ${styles.steps_form_select} ${styles.Arrow}`}>
                          ...
                          <div className="row">
                          <label className={styles.form_label}>Date Founded</label> 
