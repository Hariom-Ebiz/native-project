...
const Index = ({ employerPageBlocks, testimonials }) => {
  ...
  const GateCards = [
    {
      ...employerPageBlocks["efficient-candidate-search-and-contact"],
      button: "Lets Start",
      path: "/employer/search-cv",
    },
    {
      ...employerPageBlocks["smart-job-posting~beyond-cVs"],
      button: "Lets Start",
      path: "/employer/post-job",
    },
    {
      ...employerPageBlocks["streamlined-hiring-control"],
      button: "Lets Start",
      path: "/employer/database",
    },
    {
      ...employerPageBlocks["onboarding-management"],
      button: "Lets Start",
    ...
    <PublicLayout>
      ...
      <div className="fix-btn">
        <button className="main-button">
          ...
          {t("Book a Free Info Call")}
        </button>
      </div>

      <section
        className="hero-section"
        style={{ position: "relative", background: "#f9f9fb", zIndex: 1 }}
      >
      ...
      <section className="our_gates_wrapper position-relative">
        <div className="container" style={{ marginTop: "100px" }}>
          <h2 className="section_heading">{t("What We Offer?")} </h2>
      ...
      <section className="our_story_section">
        <div className="container">
          <h2 className="section_heading">
            {t("Why Us? How We Make A Difference?")}
          </h2>
                ...
                <div className="story_inner_block">
                  <img
                    src={
                      API +
                      "/" +
                      employerPageBlocks["employee-page-why-us-1"]?.image
                    }
                    alt="icon"
                  />
                  <p
                    dangerouslySetInnerHTML={{
                      __html:
                        employerPageBlocks["employee-page-why-us-1"]
                          ?.description,
                    }}
                  />
                </div>
                ...
                <div className="story_inner_block">
                  <img
                    src={
                      API +
                      "/" +
                      employerPageBlocks["employee-page-why-us-2"]?.image
                    }
                    alt="icon"
                  />
                  <p
                    dangerouslySetInnerHTML={{
                      __html:
                        employerPageBlocks["employee-page-why-us-2"]
                          ?.description,
                    }}
                  />
                </div>
                ...
                <div className="story_inner_block">
                  <img
                    src={
                      API +
                      "/" +
                      employerPageBlocks["employee-page-why-us-3"]?.image
                    }
                    alt="icon"
                  />
                  <p
                    dangerouslySetInnerHTML={{
                      __html:
                        employerPageBlocks["employee-page-why-us-3"]
                          ?.description,
                    }}
                  />
                </div>
                ...
                <div className="story_inner_block">
                  <img
                    src={
                      API +
                      "/" +
                      employerPageBlocks["employee-page-why-us-4"]?.image
                    }
                    alt="icon"
                  />
                  <p
                    dangerouslySetInnerHTML={{
                      __html:
                        employerPageBlocks["employee-page-why-us-4"]
                          ?.description,
                    }}
                  />
                </div>
      ...
      {/* <section
        ...
        style={{
          background: `#021638 url(${BASEURL}/${employerPageBlocks?.["employer-page-companies"]?.image || ""
            })  no-repeat`,
      ...
      <section className="testimonials_section employer-testimonials">
        <div className="container">
          <div className="row g-5">
            <div className="col-sm-12 col-md-12 col-lg-5">
              <div className="testimonials_left_box">
                <div className="section_type">
                  ...
                  {employerPageBlocks?.["employer-page-testimonials"]?.title ||
                    "Testimonials"}
                </div>
                <span
                  dangerouslySetInnerHTML={{
            ...
            <div className="col-sm-12 col-md-12 col-lg-7">
              <div className="testimonials_block">
                <div className="swiper testimonials-slider testimonials-arrow">
                          ...
                          <div className="swiper-slide">
                            <div className="slide_inner_box">
                              <div className="user_img_box">
                                <img src={`${BASEURL}/${d?.image}`} alt="" />
                              </div>
                              <div className="slider_user_details">
                                <h3>
                                  {d?.language_designation || d?.designation}
                                </h3>
                                
                                
                                
                                
                                <p className="testimonials_review_track">{d?.language_comment || d?.comment}</p>
                                ...
                                <div className="name_rating">
                                  ...
                                  <div className="star_rating">
                                    {new Array(d.rating).fill(0).map((_) => {
      ...
      <section className="company-logo">
        <div className="container">
          ...
          <div class="slider">
            <div className="logosList slide-track">
              <div className="company-logo_div slide">
                <img src="img/Coveralls.png" className="img-fluid" alt="" />
              </div>
              <div className="company-logo_div slide">
                <img src="img/Coursera.png" className="img-fluid" alt="" />
...
export async function getServerSideProps(context) {
  ...
  let data = await getEmployerPageData(lang);
  return {
    props: {
      ...data,
      isProtected: null,
      ...(await serverSideTranslations(lang_code, ["common"])),
    },
  };
}
