    ...
    <>
        ...
        <div className={`row ${styles.row_gap}`}>
          <div className="col-sm-4">
            <div className={styles.post_job_left_section}>
              <h3 className={styles.inner_box_title}>{t("Job Description")} </h3>
            ...
            <div className={`${styles.post_job_right_section}`}>
              <Form.Control
                ...
                {...register("job_description", {
                  ...
                  maxLength: {
                    value: 500,
                    message: "Job description should be under 500 character."
                  },
                })}
                maxLength={500}
              />
      ...
      <div className={` ${styles.job_details_box}`}>
        <div className={`row ${styles.row_gap}`}>
          <div className="col-sm-4">
            <div className={styles.post_job_left_section}>
              <h3 className={styles.inner_box_title}>{t("Job Requirements")} </h3>
              {/* <p className={styles.inner_box_subtitle}>
      ...
      <div className={` ${styles.job_details_box}`}>
        <div className={`row ${styles.row_gap}`}>
          ...
          <div className="col-sm-8">
            ...
            <Creatable 
              {
                ...register("keywords", {required: {value: true, message: "This field is required"}})
              }
              onChange={(v) => {
                setValue("keywords", v)
              }}
