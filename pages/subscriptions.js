              ...
              <ul className="sideNav_menu">
                ...
                <li className="dash_nav_item">
                  <a
                    ...
                    className="subMenuLink collapsed"
                    data-bs-toggle="collapse"
                    data-bs-target="#subscriptionSUbmenu"
                  >
                    <span className="icon_holder">
                      <svg
                        width="24"
                  ...
                  <ul className="subMenuSide collapse" id="subscriptionSUbmenu">
                    <li>
                      <a href="#" className="">
                        <span>
                          <svg
              ...
              <div className={styles.subscription_head}>
                  <ul className={styles.subscription_tabs}>
                      ...
                      <li className={`${styles.subscription_tabs_items}`}>
                          <a href="#" className={styles.nav_link}>Expansion/Renewal – Save 10%</a>
                      </li>
                  </ul>
              </div>
                ...
                <div className={styles.dash_pricingCardBox}>
                          <div className={styles.pricingCard}>
                              ...
                              <li className={styles.plans_items}>Unlimited Candidates' Invitationt</li>
                          ...
                          <div className={styles.plans_box}>
                            ...
                            <div className={`${styles.plans_items_track}`}>
                                  ...
                                  <div className={styles.card_detail_box}>
                                    <div className={styles.card_head}>
                                      <h3 className={styles.paln_heading}>Basic</h3>
                            ...
                            <div className={`${styles.plans_items_track}`}>
                                ...
                                <div className={styles.card_detail_box}>
                                  <div className={styles.card_head}>
                                    <h3 className={styles.paln_heading}>Essential</h3>
                                      <div className={styles.price_box}>
                                         
                                            <h4 className={styles.price_title}>2,750 <span className={styles.price_sub_title}>EGP</span></h4>
                                            <a href="#" className={styles.price_btn}>Get started</a>
                                      </div>
                                    </div>
                                    <ul className={styles.plans_name_box}>
                            ...
                            <div className={`${styles.plans_items_track} ${styles.active}`}>
                                <div className={styles.recommended_box}>
                                  <span className={styles.recommended_title}>Recommended</span>

                                </div>
                                <div className={styles.card_detail_box}>
                                  <div className={styles.card_head}>
                                    <h3 className={styles.paln_heading}>Professional</h3>
                                      <div className={styles.price_box}>
                                            <span className={styles.offer_label}>save 15%</span>
                                            <h4 className={styles.price_title}>6,950 <span className={styles.price_sub_title}>EGP</span></h4>
                                            <a href="#" className={styles.price_btn}>Get started</a>
                                      </div>
                                    </div>
                                    <ul className={styles.plans_name_box}>
                              ...
                              <div className={`${styles.plans_items_track}`}>
                                ...
                                <div className={styles.card_detail_box}>
                                  <div className={styles.card_head}>
                                    <h3 className={styles.paln_heading}>Ultimate</h3>
                                      <div className={styles.price_box}>
                                            <span className={styles.offer_label}>save 30%</span>
                                            <h4 className={styles.price_title}>9,650 <span className={styles.price_sub_title}>EGP</span></h4>
                                            <a href="#" className={styles.price_btn}>Get started</a>
                                      </div>
                                    </div>
                                    <ul className={styles.plans_name_box}>
